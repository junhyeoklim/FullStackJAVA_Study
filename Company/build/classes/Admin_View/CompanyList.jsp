		...
		<div class="containe-fluid board-article">
			...
			<nav class="pagination-wrapper">
				<ul class="pagination justify-content-center">
					...
					<c:set var="startPage" value="${sessionScope.pagingInfo.currentPage - 4 > 0 ? sessionScope.pagingInfo.currentPage - 4 : 1}"/>
					<c:set var ="endPage" value="${startPage + 9 <= sessionScope.pagingInfo.noOfPages ? startPage + 9 : sessionScope.pagingInfo.noOfPages}" />
