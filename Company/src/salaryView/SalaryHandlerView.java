...
public class SalaryHandlerView extends JPanel {
	private ArrayList<SalaryManVO> list = new ArrayList<>();
	...
	public void initView() {
		...
		list = new ArrayList<SalaryManVO>();
		p = new JPanel();
		//타이틀 만들기
...
//	콘솔로 입력하는 대신 JOptaionPane을 이용한 입력값 받기
	...
	public void setSalaryList(ArrayList<SalaryManVO> list) {
		this.list = list;
	}
	
	public ArrayList<SalaryManVO> getSalaryList()
	{
		return list;
	}
