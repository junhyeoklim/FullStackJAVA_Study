                    ...
                    <table border="1" id="main">
                        ...
                        <c:forEach var="dto" items="${requestScope.list}">
                            <tr>
                                ...
                                <td><a href="modify.do?s_id=${dto.s_id}">${dto.s_name}</a></td>
                                <td>${dto.s_rank}</td>
                                <td>${dto.s_mail}</td>
                        ...
                        <tr>
                            <td colspan="5" id="footer"><input type="button" class="btn btn-outline-secondary" id="btn" value="등록"></td>
                        </tr>
                    </table>
                    <nav class="navbar navbar-light bg-white" id="listsearch">
                        <div class="container-fluid">
                            <form class="d-flex" method="post" action="${contextPath}/search.do">
                                ...
                                <input type="submit" class="btn btn-outline-success" id="sbtn" value="검색">
                            </form>
                        </div>
                    </nav>
                    ...
                    <nav class="pagination-wrapper">
                        <ul class="pagination justify-content-center">
                            <c:if test="${requestScope.pagingInfo.currentPage > 1}">
                                <li class="page-item">
                                    <a class="page-link" href="<c:url value='list.do'>
