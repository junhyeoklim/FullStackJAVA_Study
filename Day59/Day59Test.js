// document.querySelector("#btn").setAttribute("style","display: inline;");

// 1번 문제
// let btn = "<input type='button' value='Create Button' id='create'>";
//             document.getElementById("btn").innerHTML = btn;
            

// let createB = document.querySelector("#create");
...
// 2번 문제
// document.getElementById("text").textContent  = "This is a paragraph.";
...
// let click = document.querySelector("#create");

//  click.addEventListener("click",() =>
// {
//     let newBtn = document.createElement("button");
//     newBtn.innerHTML = "Click Me";
//     div.insertBefore(newBtn,p);
    
// });

// 게임 화면 구성을 javascript로만 씀
(function createGame() {
    ...
    inputNum.addEventListener("keypress",(e) =>{
        ...
        function startGame() {
            ...
            {
                show[2].textContent = "Wrong range or Type, Please retry <br>Your Chance : "+cnt;
