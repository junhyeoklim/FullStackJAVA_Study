					...
					<article class="board-article">
						<div class="board-article-list">
							...
							<c:forEach var="board" items="${list}">
								<a class="vrow column"
									href="${contextPath}/increaseViewCount.do?category=nomal&b_id=${board.b_id}&redirect=${contextPath}/viewboard.do?category=nomal&b_id=${board.b_id}">
									<div class="vrow-inner">
										<div class="vrow-top">
						...
						<form class="search-form" method="post"
							action="${contextPath}/SearchBoard.do">
